			...
			<div class="conLeft">
				...
				<form style="width:100%;">
					...
					<%
							...
							int hCNum = hotBean.getPostCNum();
							int hNo = hotBean.getPostNo();
					...
					<div class="blogItems">
						<div class="blogLeft">
							<a href="../blog/blog_<%=hId %>.jsp?cateNum=<%=hCNum %>&postNum=<%=hNo %>" class="fullLink-col">
			...
			<div class="conRight">
				...
				<div class="loginBox">
					<div class="loginBoxTop" style="flex-direction: column;">
						...
						<div>
							<a href="../member/logout.jsp">로그아웃</a><span style="margin: 5px;"></span>
							<a href="../member/myAccount.jsp">회원정보</a>
						</div>						
					</div>
				...
				<div class="loginBox">
					<div class="loginBoxTop">
						<input class="loginButton" onclick="location.href='../member/login.jsp?returnPage=../chu/index.jsp'" type="button" value="로그인">
					</div>
